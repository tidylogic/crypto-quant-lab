...
- **페어 / 상품 및 거래소:** `[목록]`
- **시장 유형:** `[현물 / 무기한 선물 / 기타]`
- **허용 국면 참조:** `[작성 완료한 시장 국면 템플릿 링크 또는 경로]`
- **제외 국면 참조:** `[작성 완료한 시장 국면 템플릿 링크 또는 경로]`
- **거래 세션 / 시간대:** `[규칙]`

## 정확한 최초 진입

- **의사결정 시점에 이용 가능한 데이터:** `[완료 캔들 지표, 오더북/유동성 데이터, 펀딩 데이터 등]`
- **롱 진입 규칙:** `[정확한 불리언 조건, 주문 유형 및 트리거 시점]`
- **숏 진입 규칙:** `[정확한 불리언 조건, 주문 유형 및 트리거 시점 또는 N/A]`
...
| --- | --- | --- | --- |
| `[지표 / 되돌아보기 기간 / 임계값 / 진입 시점]` | `[경계가 있는 범위]` | `[가설 근거]` | `[예]` |
| `[파라미터]` | `[경계가 있는 범위]` | `[가설 근거]` | `[예]` |
